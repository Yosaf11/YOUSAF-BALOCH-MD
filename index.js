const {
  ...
  const ownerNumber = ['923115971525']
...
const sessdata = config.SESSION_ID.replace("MR.YOUSAF-MD~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there YOUSAF-BALOCH-MD User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet YOUSAF-BALOCH-MD WhatsApp Bot.\n\n *Thanks for using YOUSAF-BALOCH-MD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029Vb3Uzps6buMH2RvGef0j\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/YosafN/YOUSAF-BALOCH-MD-V5\n\n> © Powered BY MR YOUSAF BALOCH\ud83d\udda4`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('923470027813', '923115971525', '923075134110');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("923115971525")){
  if(isReact) return
  m.react("🪀")
   }
  //==========public react============//
