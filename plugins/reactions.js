    ...
    async (conn, mek, m, { args, q, reply }) => {
        try {
            ...
            if (mentionedUser) {
                ...
                message = `> © Powᴇʀᴇᴅ Bʏᴇ 𝐘𝐎𝐔𝐒𝐀𝐅 𝐁𝐀𝐋𝐎𝐂𝐇 𝐌𝐃`;
            }
